...
static class Utilitarios
{
    ...
    public static byte[] Image_ArrayBytes(Image imagen)
    {
    ...
    public static Image ArrayBytes_Image(byte[] arrayBytes)
    {
        using (var stream = new System.IO.MemoryStream(arrayBytes))
        {
            return new System.Drawing.Bitmap(stream) ?? null;
        }
    }

    public static bool ValidarValorNumerico(string n)
    {
        bool isNumber = false;
        int number;
    ...
    public static bool FormatoCorreo(string c)
    {
        bool formato = false;
    ...
    public static bool FormatoContrasena(string c)
    {
        bool formato = false;

        //Valida que tenga números
        if (c.Contains("1") || c.Contains("2") || c.Contains("3") || c.Contains("4") || c.Contains("5") ||
    ...
    public static bool LongitudContrasena(string c)
    {
        bool formato = false;
    ...
    public static bool LongitudIdentficacion(string i)
    {
        bool formato = false;
    ...
    public static bool LongitudTelefono(string t)
    {
        bool formato = false;
    ...
    public static string TerminosAndCondicionesMembresia()
    {
        StringBuilder hilera = new StringBuilder();
        hilera.Append("1. Precio y tarifas: La membresía puede tener un precio de membresía inicial y tarifas recurrentes. Los términos y condiciones deben establecer claramente el costo de la membresía y cualquier tarifa adicional que pueda aplicar." +
            "\r\n\r\n2. Período de membresía: Las membresías pueden tener una duración determinada, como un año, o pueden renovarse automáticamente a menos que el cliente cancele. Los términos y condiciones deben especificar claramente la duración de la membresía y cualquier término relacionado con la renovación." +
            "\r\n\r\n3. Beneficios de la membresía: Los clientes pueden recibir beneficios adicionales por unirse a la membresía, como descuentos en productos o servicios adicionales. Los términos y condiciones deben detallar claramente estos beneficios y cualquier restricción." +
            "\r\n\r\n4. Cancelación de la membresía: Los clientes pueden querer cancelar su membresía por diversas razones. Los términos y condiciones deben establecer las condiciones bajo las cuales los clientes pueden cancelar y cualquier penalización que pueda aplicarse." +
            "\r\n\r\n5. Responsabilidades del cliente: Los clientes deben cumplir con ciertas responsabilidades al unirse a una membresía, como proporcionar información precisa y mantener su información de contacto actualizada. Los términos y condiciones deben describir estas responsabilidades y cualquier consecuencia por no cumplirlas.");
